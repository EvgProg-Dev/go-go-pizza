...
export const renderModalPizza = ({ id, images, name, price, toppings }) => {
    ...
    addToCartBtn.classList.add("modal-pizza-add-cart");
    ...
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="14.833" y="4" width="0.851136" height="15.3204" transform="rotate(45 14.833 4)"
            fill="#C1AB91" />
        <rect x="4" y="4.60183" width="0.851136" height="15.3204" transform="rotate(-45 4 4.60183)"
            fill="#C1AB91" />
    </svg>`;
